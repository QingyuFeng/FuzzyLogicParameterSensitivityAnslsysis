...
from numpy import *
from SAF2_LS_FuzzyLogicProcess_Salinity import *
...
criteria = {"depth":depth_input, "slope":slope_input, 
            "salinity":salinity_input, "ph":ph_input, "prcp_grow":prcp_grow_input}
...
= criteria_scale(prcp_grow_max, prcp_grow_min)
