...
def fuzzylogic(landfactor, max_v, min_v, mpl_v, mpr_v, lmp_v, rmp_v):
    """
    ...
    ph_fhs = fuzzification_htra(landfactor[3], max_v, min_v, mpl_v, mpr_v)
    ph_fms = fuzzification_mtra(landfactor[3], max_v, min_v, mpl_v, mpr_v, lmp_v, rmp_v)
    ph_fns = fuzzification_ntra(landfactor[3], max_v, min_v, mpl_v, mpr_v)
