...
def fuzzylogic(landfactor, max_v, min_v, mp_v):
    ...
    slope_fhs = fuzzification_ztri(landfactor[2], max_v, min_v)
    slope_fms = fuzzification_tri(landfactor[2], max_v, min_v, mp_v)
    slope_fns = fuzzification_stri(landfactor[2], max_v, min_v)
