...
def fuzzylogic(landfactor, max_v, min_v, mp_v):
    ...
    prcpgrows_fhs = fuzzification_stri(landfactor[4], max_v, min_v)
    prcpgrows_fms = fuzzification_tri(landfactor[4], max_v, min_v, mp_v)
    prcpgrows_fns = fuzzification_ztri(landfactor[4], max_v, min_v)
